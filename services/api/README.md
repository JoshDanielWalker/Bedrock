...
![Run Tests](https://github.com/JoshDanielWalker/bedrock/workflows/Tests/badge.svg)
...
- `ADMIN_EMAIL` - Default dashboard admin user `info@bedrock.co.uk`
...
- `POSTMARK_FROM` - Reply email address `no-reply@bedrock.co.uk`
